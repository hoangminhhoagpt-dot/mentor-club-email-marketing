# 00 — PHIẾU INPUT (điền xong là chạy) — Email Marketing 11 bảng
...
|---|---|---|---|
| 1 | **Base 11 bảng** — nhân bản Base Mẫu (link `itto.yaml → input.base_mau.template_url`) | app_token = `__________` | ☐ |
...
| 6 | **Preflight**: `npm install && npm run check` → **XANH hết** (Lark · app_token · 11 bảng · SMTP) | ✅ / ❌ | ☐ |
...
> `LARK_APP_ID`, `LARK_WIKI_TOKEN`, id 11 bảng, địa chỉ gửi, host SMTP/IMAP đã có **default sẵn**
